...
def setupData(expInfo, dataDir=None):
    ...
    if dataDir is None:
        dataDir = _thisDir
    filename = u'data/'+('sub-'+ expInfo['participant'] + '_' + expName + '_raw')
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ellepedaci/Desktop/Experiments/PA3/N170/N170_lastrun.py',
